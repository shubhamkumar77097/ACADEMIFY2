...
import RatingSlider from '../components/core/About/RatingSlider'
  ...
  return (
    <div className='w-full mx-auto text-white'>
      ...
      <section className='bg-richblack-800'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-50 text-center text-white'>
            <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                Driving Innovation in Online Education for a 
                Brighter Future
                <p className='mx-auto mt-0 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>Academify is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
            </header>
            <div className='sm:h-[90px] lg:h-[12px]'></div>
        </div>
      </section>
    ...
    <img src={BannerImage1} style={{ maxWidth: '33%', height: 'auto', flexShrink: 0 }} />
    <img src={BannerImage2} style={{ maxWidth: '33%', height: 'auto', flexShrink: 0 }} />
    <img src={BannerImage3} style={{ maxWidth: '33%', height: 'auto', flexShrink: 0 }} />
</div>
      ...
      <section className='w-11/12 max-w-maxContent mx-auto p-2 flex flex-col items-center justify-between gap-5 mb-[140px] mt-16'>
        <LearningGrid />
        <ContactFormSection />
      </section>
