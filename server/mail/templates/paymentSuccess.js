const paymentSuccessEmail = (amount, paymentId, orderId, name, lastname) => {
  return `<!DOCTYPE html>
    <html>
    ...
    <body>
        <div class="container">
            <a href="https://academify-edtech-project.vercel.app"><img class="logo" src="https://i.ibb.co/270DjKh/shbm.jpg"
                    alt="Academify Logo"></a>
            <div class="message">
